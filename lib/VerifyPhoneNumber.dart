...
import 'package:newroombooking/theme.dart';
import 'package:sizer/sizer.dart';
import 'package:sms_autofill/sms_autofill.dart'; // ✅ added import
...
class _OtpVerifyScreenState extends State<OtpVerifyScreen>
  ...
  void initState() {
    ...
    // ✅ Start listening for OTP autofill
    listenForCode();
  }

  // ✅ Automatically triggered when OTP is received via SMS
  @override
  void codeUpdated() {
    void codeUpdated() {
  if (code != null && code!.isNotEmpty && code!.length >= 6) {
    ...
    setState(() => isButtonEnabled = true);
      ...
      // ✅ Optional: Automatically verify after autofill
